    ...
    <div class="swiper-container">
        <div class="swiper">
            ...
            <div class="swiper-wrapper">
              <!-- Slides -->
              <?php 
              echo "<div class=\"swiper-slide\"><img src=\"../images/cover/" .  $clubss[5]['club_cover_photo'] . "\"></div>"; ?>
              ...
            </div>
          </div>
    </div>  
    <div class="content-container">
      <div class="side-bar">
        <div class="description">
          <?php echo "<h1>" . $clubss[5]['club_title'] . "</h1>" ?>
          <?php echo "<p>" . $clubss[5]['club_description'] . "</p>"; ?>
        </div>
