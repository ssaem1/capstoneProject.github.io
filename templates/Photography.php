    ...
    <div class="swiper-container">
        <div class="swiper">
            ...
            <div class="swiper-wrapper">
              <!-- Slides -->
              <?php 
              echo "<div class=\"swiper-slide\"><img src=\"../images/cover/" .  $hobbiess[5]['hobbie_cover_photo'] . "\"></div>"; ?>
              ...
            </div>
          </div>
    </div>  
    <div class="content-container">
      <div class="side-bar">
        <div class="description">
          <?php echo "<h1>" . $hobbiess[5]['hobbie_title'] . "</h1>" ?>
          <?php echo "<p>" . $hobbiess[5]['hobbie_description'] . "</p>"; ?>
        </div>
      ...
      <div class="members">
        <div class="profile-container">
          <?php foreach($users as $user) { 
            ...
            if(in_array("Photography", $hobbies)){?>
            <div class="profile">
