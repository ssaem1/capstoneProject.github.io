    ...
    <div class="swiper-container">
        <div class="swiper">
            ...
            <div class="swiper-wrapper">
              <!-- Slides -->
              <?php 
              echo "<div class=\"swiper-slide\"><img src=\"../images/cover/" .  $years[4]['cover_photo'] . "\"></div>"; ?>
              ...
            </div>
          </div>
    </div>  
    <div class="content-container">
      <div class="side-bar">
        <div class="description">
          <?php echo "<h1>" . $years[4]['title'] . "</h1>" ?>
          <?php echo "<p>" . $years[4]['description'] . "</p>"; ?>
        </div>
