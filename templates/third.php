    ...
    <div class="swiper-container">
        <div class="swiper">
            ...
            <div class="swiper-wrapper">
              <!-- Slides -->
              <?php 
              echo "<div class=\"swiper-slide\"><img src=\"../images/cover/" .  $years[2]['cover_photo'] . "\"></div>"; ?>
              ...
            </div>
          </div>
    </div>  
    <div class="content-container">
      <div class="side-bar">
        <div class="description">
          <?php echo "<h1>" . $years[2]['title'] . "</h1>" ?>
          <?php echo "<p>" . $years[2]['description'] . "</p>"; ?>
        </div>
